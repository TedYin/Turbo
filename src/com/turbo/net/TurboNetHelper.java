 ...
 * @version 1.0.0
 */
public class TurboNetHelper {

	// 默认时长1分钟
//	private static final int SO_TIME_OUT = 60000;

	private static TurboNetHelper instance;
...
//	private static HttpClient httpClient;
	...
	private TurboNetHelper(Context context) {
		initVolley(context);
//		getHttpClient();
	}
	 ...
	 * @return
	 */
	public static TurboNetHelper newInstance(Context context) {
		if (null == instance)
			instance = new TurboNetHelper(context);
		return instance;
	}
